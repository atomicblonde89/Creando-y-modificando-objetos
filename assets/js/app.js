...
p1.setNombrePaciente("Demian")
p1.setEdad(33)
p1.setRUT(198294592)
p1.setDiagnostico("Cancer Testicular")

const p2 = new Paciente()
p2.setNombrePaciente("Atanasio")
p2.setEdad(60)
p2.setRUT(263423165)
p2.setDiagnostico("Gripe")

const p3 = new Paciente()
p3.setNombrePaciente("Paulina")
p3.setEdad(32)
p3.setRUT(125843154)
p3.setDiagnostico("Peste Negra")

const c1 = new Consultorio()
c1.setNombreConsultorio("Santa Amalia")
...
document.write("<h1>Abrir consola :) <h1>")